...
##Step 1: Reading in the dataset and/or processing the data
```{r, echo=TRUE}
...
##Step 2: Histogram of the total number of steps each day
```{r, echo = TRUE}
library(ggplot2)
...
```
##Step 4: Time series plot of the average no of steps taken
```{r, echo=TRUE}
Q4 <- Q3
...
##Step 5: The 5-min interval which contains the max no of steps
```{r, echo=TRUE}
...
plot(y=Q6.2$Missing, x=Q6.2$Interval, main = "Missing Value Distribution bt Interval")
table(activity$date)
```
...
##Step 7: Histogram of the total no of steps after missing values are imputed
...
##Step 8: Comparison between weekday and weekends
```{r, echo=TRUE}
Q8 <- Q6.6
